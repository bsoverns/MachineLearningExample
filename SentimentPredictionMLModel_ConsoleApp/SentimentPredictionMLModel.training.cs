...
namespace SentimentPredictionMLModel_ConsoleApp
{
    public partial class SentimentPredictionMLModel
    {
        public const string RetrainFilePath =  @"D:\Sandbox\MachineLearningExample\SentimentPrediction\Data\data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Sentiment",inputColumnName:@"Sentiment",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Sentiment", sentence1ColumnName: @"Sentence"))      
