...
namespace TaxiFarePrediction
{
    ...
    {    
        ...
        {
            string _trainDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\TaxiFarePrediction\Data", "taxi-fare-train.csv");
            string _testDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\TaxiFarePrediction\Data", "taxi-fare-test.csv");
            string _modelPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\TaxiFarePrediction\Data", "Model.zip");
