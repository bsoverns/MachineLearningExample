...
namespace WinFormsSalesPrediction
{
    ...
    {
        string _trainDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\WinFormsSalesPrediction\Data", "SalesData.csv");
        string _testDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\WinFormsSalesPrediction\Data", "SalesData.csv");
        string _modelPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\WinFormsSalesPrediction\Data", "Model.zip");        
