...
namespace IrisPrediction
{
    internal class Program
    {
        ...
        static readonly string _datapath = Path.Combine(@"C:\Sandbox\MachineLearningExample\IrisPrediction\Data", "iris.data");
        static readonly string _modelPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\IrisPrediction\Data", "IrisClusteringModel.zip");
