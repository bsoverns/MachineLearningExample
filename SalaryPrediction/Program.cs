...
namespace SalaryPrediction
{
    class Program
    {
        ...
        {
            string _trainDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\SalaryPrediction\Data", "SalaryData.csv");
            string _testDataPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\SalaryPrediction\Data", "SalaryData-test.csv");
            string _modelPath = Path.Combine(@"C:\Sandbox\MachineLearningExample\SalaryPrediction\Data", "Model.zip");
